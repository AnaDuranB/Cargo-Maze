...
public class CargoMazeServices {
    ...
    public boolean move(String playerId, String gameSessionId, Position direction) throws CargoMazePersistanceException, CargoMazeServicesException{
        ...
        return movePlayer(player, newPosition, gameSession);
    }

    public boolean movePlayer(Player player, Position newPosition, GameSession gameSession) {
    ...
    public boolean moveBox(Player player, Position playerPosition, Position boxPosition, Board board, GameSession gameSession) {
